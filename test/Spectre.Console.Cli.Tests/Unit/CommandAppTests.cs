...
public sealed partial class CommandAppTests
{
    ...
    public void Should_Pass_Case_6()
    {
        ...
        app.Configure(config =>
        {
            config
                .PropagateExceptions()
                .AddCommand<OptionVectorCommand>("multi");
        });
    ...
    public void Should_Be_Able_To_Use_Command_Alias()
    {
        ...
        app.Configure(config =>
        {
            config
                .PropagateExceptions()
                .AddCommand<OptionVectorCommand>("multi").WithAlias("multiple");
        });
    ...
    public void Should_Throw_If_Alias_Conflicts_With_Another_Command()
    {
        ...
        app.Configure(config =>
        {
            config
                .PropagateExceptions()
                .AddCommand<DogCommand>("dog").WithAlias("cat");
    ...
    public sealed class Delegate_Commands
    {
        ...
        public void Should_Execute_Nested_Delegate_Command()
        {
            ...
            app.Configure(config =>
            {
                config
                    .PropagateExceptions()
                    .AddBranch<AnimalSettings>("foo", foo =>
                    {
